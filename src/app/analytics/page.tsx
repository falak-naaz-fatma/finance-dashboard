            ...
            <article className="rounded-[8px] border border-white/10 bg-card p-7 shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-4 text-[30px] font-semibold leading-none text-danger">
                    {formatCurrency(analytics.highestExpenseDay.amount)}
                  </p>
                  <p className="mt-3 text-sm text-muted-foreground">{analytics.highestExpenseDay.date}</p>
                </div>
                <span className="flex size-12 items-center justify-center rounded-[14px] bg-muted text-danger">
            ...
            <article className="rounded-[8px] border border-white/10 bg-card p-7 shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-4 text-[30px] font-semibold leading-none text-primary">
                    {formatCurrency(analytics.averageDailySpend)}
                  </p>
                  <p className="mt-3 text-sm text-muted-foreground">This month</p>
                </div>
                <span className="flex size-12 items-center justify-center rounded-[14px] bg-muted text-primary">
                  ...
                  >
                    ...
                    <ReBar dataKey="amount" radius={[7, 7, 7, 7]} barSize={44}>
                      {analytics.topCategories.map((item) => (
                        <Cell key={item.category} fill="hsl(var(--primary))" />
                      ))}
                    </ReBar>
                  </ReBarChart>
                </ChartContainer>
          ...
          <section className="mt-7 rounded-[8px] border border-white/10 bg-card p-7 shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">Last 12 weeks</p>
              </div>
